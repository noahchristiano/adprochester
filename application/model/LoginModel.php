...
class LoginModel
{
    ...
    public static function login($user_email, $user_password, $set_remember_me_cookie = null)
    {
        ...
        self::setSuccessfulLoginIntoSession($result->user_id, $result->user_email, $result->user_first_name, $result->user_last_name, $result->user_account_type);
     ...
     */
    public static function setSuccessfulLoginIntoSession($user_id, $user_email, $user_first_name, $user_last_name, $user_account_type)
    {
        Session::init();
