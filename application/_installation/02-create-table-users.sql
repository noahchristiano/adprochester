CREATE TABLE IF NOT EXISTS `fraternity`.`users` (
 ...
 `user_has_image` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1 if user has a local image, 0 if not',
 ...
 `user_middle_name` varchar(64) DEFAULT NULL,
